...
CARA DEPLOY KE HOSTING FIREBASE
- jgn lupa perhattiin .firebaserc agar refer ke hostingnya, 
contoh urlnya "enterevent-a094f.firebaseapp.com" berarti ke enterevent-a094f
- npm run build
- firebase init
- firebase serve
- firebase deploy